#!/usr/bin/env python3
# BenchFlow Interface for MGSM
# This file is a template for integrating MGSM with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading MGSM benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "github": "https://github.com/google-research/url-nlp/tree/main/mgsm",
            "paper": "",
            "website": ""
        }
